    ...
    <div class="flex w-full flex-col gap-2">
        ...
        <div class="relative flex items-center">
            ...
            <input
                ...
                class="border-border bg-bg-secondary text-text-primary focus:border-accent w-full rounded-lg border px-2.5 py-2.5 pr-10 text-sm transition-colors duration-150 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60"
                :class="{
